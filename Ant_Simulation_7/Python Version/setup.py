...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Ant Simulation"
 
        #Project url
        self.project_url = "about:none"
 
        #Version of program
        self.project_version = "7.0"
 
        #License of the program
        self.license = "GPLv3"
 
        #Auhor of program
        self.author_name = "Malte Lichtenberg, Lucas Tittmann"
        self.author_email = "lucas.tittmann@ensae.fr"
        self.copyright = "Copyright (c) 2012 Andarin"
 
        #Description
        self.project_description = "Ant Simulation by Andarin Software"
