...
def max_int(a, b): return a if a > b else b

class Ant_mod():

    def ctake_step (self):
        preferation_matrix = self.preferation_matrix
        perception = self.perception
        aim = self.aim
        index_smells_good = self.index_smells_good
        index_smells_bad = self.index_smells_bad
        p_range = len(perception)
...
################################################################################
    ...
    def ctake_step_dict(self):
        ...
        r_o_p = self.range_of_perception*2 + 1
